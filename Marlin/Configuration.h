/**
 * My Tarantula config V2.0.x, DD
 *  LPC1768, MKS SGEN_L V1.0, TMC2208
 * 
 * 
...
#define STRING_CONFIG_H_AUTHOR "(DD, Tarantula 2.0 config)" // Who made the changes.
...
#define PSU_NAME "ATX - JNC-350W"
  ...
  #define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    #define AUTO_POWER_FANS            // Turn on PSU if fans need power (those fans controllable with gcode)
    //#define AUTO_POWER_E_FANS       // Extruder/Hotend cooling fan
    //#define AUTO_POWER_CONTROLLERFAN
    //#define AUTO_POWER_CHAMBER_FAN
    //#define AUTO_POWER_COOLER_FAN
    #define AUTO_POWER_E_TEMP          45 // (°C) Turn on PSU if any extruder is over this temperature
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Tevo Tarantula Hotend, PID autotune Dez 19
    #define DEFAULT_Kp 20.3
    #define DEFAULT_Ki 1.37
    #define DEFAULT_Kd 75.0
  #endif
#endif // PIDTEMP
...
// Mechanical endstop with COM to ground and NC to Signal uses "false" here (most common setup). Set to true to invert the logic of the endstop.
#define X_MIN_ENDSTOP_INVERTING true  // not yet changed from NO to NC
#define Y_MIN_ENDSTOP_INVERTING false // already changed to NC
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 300, 250, 9.5, 100 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 1500, 100, 4000 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  // #define MAX_ACCEL_EDIT_VALUES       { 3000, 3000, 120, 10000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 62, 0 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 7  // overwrite for different XY in config_adv
...
#define Z_HOMING_HEIGHT  Z_CLEARANCE_DEPLOY_PROBE // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 70), Y_MIN_POS, 10 }
