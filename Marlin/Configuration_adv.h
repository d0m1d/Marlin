...
#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  #define FAST_PWM_FAN_FREQUENCY 7800  // Define here to override the defaults below
...
#define AXIS_RELATIVE_MODES { false, false, false }  // needs an element for every "axis" incl. extruder
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 70*60, 70*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define LCD_TIMEOUT_TO_STATUS 15000   // (ms)
    ...
    #define BOOTSCREEN_TIMEOUT 1200       // (ms) Total Duration to display the boot screen(s)
...
// LCD Print Progress options
    ...
    #define LCD_PROGRESS_BAR            // Show a progress bar on HD44780 LCDs for SD printing
      ...
      #define PROGRESS_BAR_BAR_TIME 4000  // (ms) Amount of time to show the bar
      #define PROGRESS_BAR_MSG_TIME 4000  // (ms) Amount of time to show the status message
 ...
 */
  ...
  #define HOLD_MULTIPLIER    1.0  // Scales down the holding current from run current; tmc2209 datasheet: <12Hz STEP pin input freq -> considered standstill -> current reduction
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       1700        // (mA) RMS current. Multiply by 1.414 for peak current. TMC2209 max 2Arms
...
//#define LASER_FEATURE
  ...
  #define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
     ...
     */
      ...
      #define SPEED_POWER_MAX         30030    // (RPM) SuperPID router controller 0 - 30,000 RPM
      #define SPEED_POWER_STARTUP      5120    // (RPM) M3/M4 speed/power default (with no arguments)
    #endif
    ...
    //#define LASER_POWER_INLINE
      ...
      #define SPINDLE_LASER_POWERDOWN_DELAY   3000 // (ms) Delay to allow the spindle to stop
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_11_DESC "ProbeZ-X+Y+, set -2.5"
  #define MAIN_MENU_ITEM_11_GCODE "G38.2 Z20 F150\nG92 Z0\nG0 Z5\nG91\nG0 X-35\nG0 Z-10\nG38.2 X400 F400\nG92 X-2.5\nG1 X-5\nG0 Z10\nG0 X15 Y-35\nG0 Z-10\nG38.2 Y400 F400\nG92 Y-2.5\nG1 Y-5\nG90\nG0 Z10\nG0 X0 Y0"
  
  #define MAIN_MENU_ITEM_12_DESC "ProbeZ-X+Y+, set -2"
  #define MAIN_MENU_ITEM_12_GCODE "G38.2 Z20 F150\nG92 Z0\nG0 Z5\nG91\nG0 X-35\nG0 Z-10\nG38.2 X400 F400\nG92 X-2\nG1 X-5\nG0 Z10\nG0 X15 Y-35\nG0 Z-10\nG38.2 Y400 F400\nG92 Y-2\nG1 Y-5\nG90\nG0 Z10\nG0 X0 Y0"
...
#define FREEZE_FEATURE
  ...
  #define FREEZE_PIN PA8   // Override the default (KILL) pin 41 here, was SERVO0_PIN PA8 on MKS_eagle
